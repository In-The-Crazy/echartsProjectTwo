...
<head>
    ...
    <script type="text/javascript" src="<%=root%>/js/echartsProject/flightPriceAnalysisFuture.js"></script>
        ...
        <div class="buttonbar">
            <div align="left">
                <form id="conditionForm" name="conditionForm">
                    ...
                    <fieldset>
                        <select id="schedule" name="schedule" class="easyui-combobox" editable="false">
                        </select>
                    </fieldset>
